...
# Plot wage vs education, differentiated by marital status
...
print(df[['mmale', 'mfemale', 'sfemale']].head())

import statsmodels.api as sm

# Define the independent variables (including a constant term for intercept)
X = df[['sfemale', 'mfemale', 'mmale', 'educ', 'exper', 'tenure']]
